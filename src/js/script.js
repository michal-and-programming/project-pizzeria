...

{
    ...
    prepareCartProductParams() {
      ...
      for(let paramId in thisProduct.data.params) {
        ...
        for(let optionId in param.options) {
          ...
          if(optionSelected) {
            params[paramId].options = option// option is selected!
          }
        }
      }
  ...
  class Cart{
    ...
    getElements(element){
      ...
      thisCart.dom.orderPrice = thisCart.dom.wrapper.querySelector("cart_order-price-sum");
      thisCart.dom.form = thisCart.dom.wrapper.querySelector(select.cart.form);
      thisCart.dom.address.value = thisCart.dom.wrapper.querySelector(select.cart.address);
      thisCart.dom.phone.value = thisCart.dom.wrapper.querySelector(select.cart.phone);
    }
    ...
    update(){
      ...
      thisCart.dom.orderPrice.innerHTML  = thisCart.totalPrice;
    }
...
//Product → prepareCartProduct() → productSummary → Cart.add(menuProduct) → new CartProduct(menuProduct)